...
ONLY return valid JSON (no markdown):
{
  ...
  "imagePrompt":"<English ONLY image prompt. MANDATORY RULES:\n1. Read the FULL diary. Find the most vivid/emotional moment.\n2. Include: WHO + WHAT ACTION + WHERE + KEY DETAIL.\n3. Never use vague descriptions or only illustrate the first sentence.\n4. STYLE RULE — choose based on the richness score you assigned:\n   • richness 1-3: grayscale, low saturation, very simple minimal sketch, few flat colors, child crayon drawing style, simple shapes only\n   • richness 4-7: simple crayon drawing, limited color palette, warm pastel tones, child-like illustration style, slightly detailed\n   • richness 8-10: vivid colorful crayon drawing, high saturation, rich expressive colors, detailed child-drawn watercolor crayon style, lively and energetic\n5. ALL styles: crayon texture, hand-drawn look, Korean children's picture book feel, no text, no letters, no numbers\n6. FORMAT: [who] [action] [where], [sensory/emotional detail], [STYLE from rule 4 above]>",
