...
ONLY return valid JSON (no markdown):
{
  ...
  "imagePrompt":"<English ONLY image prompt. MANDATORY RULES:\n1. Read the FULL diary. Find the most vivid/emotional moment.\n2. Include: WHO + WHAT ACTION + WHERE + KEY DETAIL.\n3. Never use vague descriptions or only illustrate the first sentence.\n4. CRITICAL STYLE RULE — choose EXACTLY ONE block based on richness score:\n   • richness 1-3: drawn with gray and beige crayons only, extremely simple rough sketch, very few crude shapes, minimal detail, no background fill, child scribble style, monochrome crayon on white paper, flat and unfinished look\n   • richness 4-7: Korean child's crayon drawing on white paper, simple chunky outlines drawn with wax crayon, soft pastel crayon colors (3-4 colors max), visible crayon stroke texture, slightly detailed scene, flat color fills with crayon grain visible\n   • richness 8-10: vibrant Korean child's crayon and watercolor drawing, thick expressive wax crayon outlines, highly saturated crayon colors filling the scene, visible layered crayon strokes, watercolor wash blending beneath crayon lines, decorative star and flower doodles scattered around, rich colorful scene full of energy and joy\n5. ALL styles MUST HAVE: wax crayon texture throughout, hand-drawn imperfect lines, Korean elementary school picture diary feel, no anime style, no realistic rendering, no digital clean lines, no text, no letters, no numbers\n6. FORMAT: [who] [action] [where], [key detail from diary], [copy the exact style block from rule 4 above]>",
