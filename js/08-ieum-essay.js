...
const ESSAY_TOPICS = [
   ...
   * 출처: 2022 개정 교육과정(교육부 고시 제2022-33호) [별책5] 국어과
   *       [6국03-02] 적절한 근거를 사용하고 인용의 출처를 밝히며
   *                  주장하는 글을 쓴다. (5~6학년군 쓰기)
   *       ※ 2026학년도부터 5~6학년군에 2022 개정 최초 적용
   *         (구 코드 2015 개정 [4국03-03]은 3~4학년군 기준이라 상위
   *          학년군 성취기준으로 갱신함)
   *       "주장과 근거를 판단해요"(논설문 단원) 등에 실제로 제시되는
